...
/*  13:    */ 
/*  14:    */ public class ByteObjectHashMap<V>
/*  15:    */   implements ByteObjectMap<V>
/*  16:    */ {
...
/*  22:    */   private byte[] keys;
/*  23:    */   private V[] values;
/*  24:    */   private int size;
/*  25:    */   private int mask;
/*  26: 62 */   private final Set<Byte> keySet = new KeySet(null);
/*  27: 63 */   private final Set<Map.Entry<Byte, V>> entrySet = new EntrySet(null);
/*  28: 64 */   private final Iterable<ByteObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*  29:    */   {
/*  30:    */     public Iterator<ByteObjectMap.PrimitiveEntry<V>> iterator()
/*  31:    */     {
/*  32: 67 */       return new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/*  33:    */     }
/*  34:    */   };
/*  35:    */   
/*  36:    */   public ByteObjectHashMap()
/*  37:    */   {
/*  38: 72 */     this(8, 0.5F);
/*  39:    */   }
/*  40:    */   
/*  41:    */   public ByteObjectHashMap(int initialCapacity)
/*  42:    */   {
/*  43: 76 */     this(initialCapacity, 0.5F);
/*  44:    */   }
/*  45:    */   
/*  46:    */   public ByteObjectHashMap(int initialCapacity, float loadFactor)
/*  47:    */   {
...
/*  56:    */     
/*  57:    */ 
/*  58: 93 */     this.keys = new byte[capacity];
/*  59:    */     
...
/* 105:    */   }
/* 106:    */   
/* 107:    */   public void putAll(Map<? extends Byte, ? extends V> sourceMap)
/* 108:    */   {
/* 109:    */     ByteObjectHashMap<V> source;
/* 110:148 */     if ((sourceMap instanceof ByteObjectHashMap))
/* 111:    */     {
/* 112:151 */       source = (ByteObjectHashMap)sourceMap;
...
/* 120:158 */       return;
/* 121:    */     }
/* 122:162 */     for (Map.Entry<? extends Byte, ? extends V> entry : sourceMap.entrySet()) {
/* 123:163 */       put((Byte)entry.getKey(), entry.getValue());
/* 124:    */     }
/* 125:    */   }
/* 126:    */   
/* 127:    */   public V remove(byte key)
/* 128:    */   {
...
/* 149:    */   {
/* 150:191 */     Arrays.fill(this.keys, (byte)0);
...
/* 169:    */   }
/* 170:    */   
/* 171:    */   public Iterable<ByteObjectMap.PrimitiveEntry<V>> entries()
/* 172:    */   {
...
/* 183:    */         {
/* 184:225 */           final ByteObjectHashMap<V>.PrimitiveIterator iter = new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/* 185:    */           
...
/* 203:    */       public int size()
/* 204:    */       {
/* 205:246 */         return ByteObjectHashMap.this.size;
/* 206:    */       }
/* 207:    */     };
/* 208:    */   }
/* 209:    */   
...
/* 213:257 */     for (byte key : this.keys) {
...
/* 222:273 */       return true;
/* 223:    */     }
/* 224:275 */     if (!(obj instanceof ByteObjectMap)) {
/* 225:276 */       return false;
/* 226:    */     }
/* 227:279 */     ByteObjectMap other = (ByteObjectMap)obj;
...
/* 260:    */   }
/* 261:    */   
/* 262:    */   public V put(Byte key, V value)
/* 263:    */   {
...
/* 270:    */   }
/* 271:    */   
/* 272:    */   public Set<Byte> keySet()
/* 273:    */   {
/* 274:322 */     return this.keySet;
/* 275:    */   }
/* 276:    */   
/* 277:    */   public Set<Map.Entry<Byte, V>> entrySet()
/* 278:    */   {
/* 279:327 */     return this.entrySet;
/* 280:    */   }
/* 281:    */   
/* 282:    */   private byte objectToKey(Object key)
/* 283:    */   {
/* 284:331 */     return ((Byte)key).byteValue();
/* 285:    */   }
/* 286:    */   
/* 287:    */   private int indexOf(byte key)
/* 288:    */   {
...
/* 301:    */   }
/* 302:    */   
/* 303:    */   private int hashIndex(byte key)
/* 304:    */   {
/* 305:365 */     return hashCode(key) & this.mask;
/* 306:    */   }
/* 307:    */   
/* 308:    */   private static int hashCode(byte key)
/* 309:    */   {
/* 310:372 */     return key;
/* 311:    */   }
/* 312:    */   
...
/* 369:    */   {
/* 370:452 */     byte[] oldKeys = this.keys;
/* 371:453 */     V[] oldVals = this.values;
/* 372:    */     
/* 373:455 */     this.keys = new byte[newCapacity];
/* 374:    */     
...
/* 423:    */   }
/* 424:    */   
/* 425:    */   protected String keyToString(byte key)
/* 426:    */   {
/* 427:513 */     return Byte.toString(key);
/* 428:    */   }
/* 429:    */   
/* 430:    */   private final class EntrySet
/* 431:    */     extends AbstractSet<Map.Entry<Byte, V>>
/* 432:    */   {
/* 433:    */     private EntrySet() {}
/* 434:    */     
/* 435:    */     public Iterator<Map.Entry<Byte, V>> iterator()
/* 436:    */     {
/* 437:522 */       return new ByteObjectHashMap.MapIterator(ByteObjectHashMap.this, null);
/* 438:    */     }
/* 439:    */     
/* 440:    */     public int size()
/* 441:    */     {
/* 442:527 */       return ByteObjectHashMap.this.size();
/* 443:    */     }
/* 444:    */   }
/* 445:    */   
/* 446:    */   private final class KeySet
/* 447:    */     extends AbstractSet<Byte>
/* 448:    */   {
/* 449:    */     private KeySet() {}
/* 450:    */     
/* 451:    */     public int size()
/* 452:    */     {
/* 453:537 */       return ByteObjectHashMap.this.size();
/* 454:    */     }
/* 455:    */     
/* 456:    */     public boolean contains(Object o)
/* 457:    */     {
/* 458:542 */       return ByteObjectHashMap.this.containsKey(o);
/* 459:    */     }
/* 460:    */     
/* 461:    */     public boolean remove(Object o)
/* 462:    */     {
/* 463:547 */       return ByteObjectHashMap.this.remove(o) != null;
/* 464:    */     }
/* 465:    */     
/* 466:    */     public boolean retainAll(Collection<?> retainedKeys)
/* 467:    */     {
/* 468:552 */       boolean changed = false;
/* 469:553 */       for (Iterator<ByteObjectMap.PrimitiveEntry<V>> iter = ByteObjectHashMap.this.entries().iterator(); iter.hasNext();)
/* 470:    */       {
/* 471:554 */         ByteObjectMap.PrimitiveEntry<V> entry = (ByteObjectMap.PrimitiveEntry)iter.next();
/* 472:555 */         if (!retainedKeys.contains(Byte.valueOf(entry.key())))
/* 473:    */         {
...
/* 482:    */     {
/* 483:565 */       ByteObjectHashMap.this.clear();
/* 484:    */     }
/* 485:    */     
/* 486:    */     public Iterator<Byte> iterator()
/* 487:    */     {
/* 488:570 */       new Iterator()
/* 489:    */       {
/* 490:571 */         private final Iterator<Map.Entry<Byte, V>> iter = ByteObjectHashMap.this.entrySet.iterator();
/* 491:    */         
...
/* 495:    */         }
/* 496:    */         
/* 497:    */         public Byte next()
/* 498:    */         {
/* 499:580 */           return (Byte)((Map.Entry)this.iter.next()).getKey();
/* 500:    */         }
/* 501:    */         
...
/* 511:    */     implements Iterator<ByteObjectMap.PrimitiveEntry<V>>, ByteObjectMap.PrimitiveEntry<V>
/* 512:    */   {
...
/* 520:    */     {
/* 521:600 */       while ((++this.nextIndex != ByteObjectHashMap.this.values.length) && (ByteObjectHashMap.this.values[this.nextIndex] == null)) {}
/* 522:    */     }
/* 523:    */     
...
/* 527:607 */         scanNext();
/* 528:    */       }
/* 529:609 */       return this.nextIndex != ByteObjectHashMap.this.values.length;
/* 530:    */     }
/* 531:    */     
/* 532:    */     public ByteObjectMap.PrimitiveEntry<V> next()
/* 533:    */     {
/* 534:614 */       if (!hasNext()) {
...
/* 549:    */       }
/* 550:631 */       if (ByteObjectHashMap.this.removeAt(this.prevIndex)) {
...
/* 556:    */     public byte key()
/* 557:    */     {
/* 558:645 */       return ByteObjectHashMap.this.keys[this.entryIndex];
/* 559:    */     }
/* 560:    */     
/* 561:    */     public V value()
/* 562:    */     {
...
/* 567:    */     {
/* 568:655 */       ByteObjectHashMap.this.values[this.entryIndex] = ByteObjectHashMap.toInternal(value);
/* 569:    */     }
/* 570:    */   }
/* 571:    */   
/* 572:    */   private final class MapIterator
/* 573:    */     implements Iterator<Map.Entry<Byte, V>>
/* 574:    */   {
/* 575:663 */     private final ByteObjectHashMap<V>.PrimitiveIterator iter = new ByteObjectHashMap.PrimitiveIterator(ByteObjectHashMap.this, null);
/* 576:    */     
...
/* 582:    */     }
/* 583:    */     
/* 584:    */     public Map.Entry<Byte, V> next()
/* 585:    */     {
/* 586:672 */       if (!hasNext()) {
...
/* 590:    */       
/* 591:678 */       return new ByteObjectHashMap.MapEntry(ByteObjectHashMap.this, ByteObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/* 592:    */     }
/* 593:    */     
...
/* 601:    */     implements Map.Entry<Byte, V>
/* 602:    */   {
...
/* 608:    */     }
/* 609:    */     
/* 610:    */     public Byte getKey()
/* 611:    */     {
/* 612:699 */       verifyExists();
/* 613:700 */       return Byte.valueOf(ByteObjectHashMap.this.keys[this.entryIndex]);
/* 614:    */     }
/* 615:    */     
/* 616:    */     public V getValue()
/* 617:    */     {
/* 618:705 */       verifyExists();
/* 619:706 */       return ByteObjectHashMap.toExternal(ByteObjectHashMap.this.values[this.entryIndex]);
/* 620:    */     }
/* 621:    */     
/* 622:    */     public V setValue(V value)
/* 623:    */     {
/* 624:711 */       verifyExists();
/* 625:712 */       V prevValue = ByteObjectHashMap.toExternal(ByteObjectHashMap.this.values[this.entryIndex]);
/* 626:713 */       ByteObjectHashMap.this.values[this.entryIndex] = ByteObjectHashMap.toInternal(value);
/* 627:714 */       return prevValue;
/* 628:    */     }
/* 629:    */     
/* 630:    */     private void verifyExists()
/* 631:    */     {
/* 632:718 */       if (ByteObjectHashMap.this.values[this.entryIndex] == null) {
 ...
 * Qualified Name:     io.netty.util.collection.ByteObjectHashMap
