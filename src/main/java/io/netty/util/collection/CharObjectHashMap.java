...
/*  13:    */ 
/*  14:    */ public class CharObjectHashMap<V>
/*  15:    */   implements CharObjectMap<V>
/*  16:    */ {
...
/*  22:    */   private char[] keys;
/*  23:    */   private V[] values;
/*  24:    */   private int size;
/*  25:    */   private int mask;
/*  26: 62 */   private final Set<Character> keySet = new KeySet(null);
/*  27: 63 */   private final Set<Map.Entry<Character, V>> entrySet = new EntrySet(null);
/*  28: 64 */   private final Iterable<CharObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*  29:    */   {
/*  30:    */     public Iterator<CharObjectMap.PrimitiveEntry<V>> iterator()
/*  31:    */     {
/*  32: 67 */       return new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/*  33:    */     }
/*  34:    */   };
/*  35:    */   
/*  36:    */   public CharObjectHashMap()
/*  37:    */   {
/*  38: 72 */     this(8, 0.5F);
/*  39:    */   }
/*  40:    */   
/*  41:    */   public CharObjectHashMap(int initialCapacity)
/*  42:    */   {
/*  43: 76 */     this(initialCapacity, 0.5F);
/*  44:    */   }
/*  45:    */   
/*  46:    */   public CharObjectHashMap(int initialCapacity, float loadFactor)
/*  47:    */   {
...
/*  56:    */     
/*  57:    */ 
/*  58: 93 */     this.keys = new char[capacity];
/*  59:    */     
...
/* 105:    */   }
/* 106:    */   
/* 107:    */   public void putAll(Map<? extends Character, ? extends V> sourceMap)
/* 108:    */   {
/* 109:    */     CharObjectHashMap<V> source;
/* 110:148 */     if ((sourceMap instanceof CharObjectHashMap))
/* 111:    */     {
/* 112:151 */       source = (CharObjectHashMap)sourceMap;
...
/* 120:158 */       return;
/* 121:    */     }
/* 122:162 */     for (Map.Entry<? extends Character, ? extends V> entry : sourceMap.entrySet()) {
/* 123:163 */       put((Character)entry.getKey(), entry.getValue());
/* 124:    */     }
/* 125:    */   }
/* 126:    */   
/* 127:    */   public V remove(char key)
/* 128:    */   {
...
/* 149:    */   {
/* 150:191 */     Arrays.fill(this.keys, '\000');
/* 151:192 */     Arrays.fill(this.values, null);
/* 152:193 */     this.size = 0;
/* 153:    */   }
/* 154:    */   
/* 155:    */   public boolean containsKey(char key)
/* 156:    */   {
...
/* 169:    */   }
/* 170:    */   
/* 171:    */   public Iterable<CharObjectMap.PrimitiveEntry<V>> entries()
/* 172:    */   {
...
/* 183:    */         {
/* 184:225 */           final CharObjectHashMap<V>.PrimitiveIterator iter = new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/* 185:    */           
...
/* 203:    */       public int size()
/* 204:    */       {
/* 205:246 */         return CharObjectHashMap.this.size;
/* 206:    */       }
/* 207:    */     };
/* 208:    */   }
/* 209:    */   
...
/* 213:257 */     for (char key : this.keys) {
...
/* 222:273 */       return true;
/* 223:    */     }
/* 224:275 */     if (!(obj instanceof CharObjectMap)) {
/* 225:276 */       return false;
/* 226:    */     }
/* 227:279 */     CharObjectMap other = (CharObjectMap)obj;
...
/* 260:    */   }
/* 261:    */   
/* 262:    */   public V put(Character key, V value)
/* 263:    */   {
...
/* 270:    */   }
/* 271:    */   
/* 272:    */   public Set<Character> keySet()
/* 273:    */   {
/* 274:322 */     return this.keySet;
/* 275:    */   }
/* 276:    */   
/* 277:    */   public Set<Map.Entry<Character, V>> entrySet()
/* 278:    */   {
/* 279:327 */     return this.entrySet;
/* 280:    */   }
/* 281:    */   
/* 282:    */   private char objectToKey(Object key)
/* 283:    */   {
/* 284:331 */     return ((Character)key).charValue();
/* 285:    */   }
/* 286:    */   
/* 287:    */   private int indexOf(char key)
/* 288:    */   {
...
/* 301:    */   }
/* 302:    */   
/* 303:    */   private int hashIndex(char key)
/* 304:    */   {
/* 305:365 */     return hashCode(key) & this.mask;
/* 306:    */   }
/* 307:    */   
/* 308:    */   private static int hashCode(char key)
/* 309:    */   {
/* 310:372 */     return key;
/* 311:    */   }
/* 312:    */   
...
/* 369:    */   {
/* 370:452 */     char[] oldKeys = this.keys;
/* 371:453 */     V[] oldVals = this.values;
/* 372:    */     
/* 373:455 */     this.keys = new char[newCapacity];
/* 374:    */     
...
/* 423:    */   }
/* 424:    */   
/* 425:    */   protected String keyToString(char key)
/* 426:    */   {
/* 427:513 */     return Character.toString(key);
/* 428:    */   }
/* 429:    */   
/* 430:    */   private final class EntrySet
/* 431:    */     extends AbstractSet<Map.Entry<Character, V>>
/* 432:    */   {
/* 433:    */     private EntrySet() {}
/* 434:    */     
/* 435:    */     public Iterator<Map.Entry<Character, V>> iterator()
/* 436:    */     {
/* 437:522 */       return new CharObjectHashMap.MapIterator(CharObjectHashMap.this, null);
/* 438:    */     }
/* 439:    */     
/* 440:    */     public int size()
/* 441:    */     {
/* 442:527 */       return CharObjectHashMap.this.size();
/* 443:    */     }
/* 444:    */   }
/* 445:    */   
/* 446:    */   private final class KeySet
/* 447:    */     extends AbstractSet<Character>
/* 448:    */   {
/* 449:    */     private KeySet() {}
/* 450:    */     
/* 451:    */     public int size()
/* 452:    */     {
/* 453:537 */       return CharObjectHashMap.this.size();
/* 454:    */     }
/* 455:    */     
/* 456:    */     public boolean contains(Object o)
/* 457:    */     {
/* 458:542 */       return CharObjectHashMap.this.containsKey(o);
/* 459:    */     }
/* 460:    */     
/* 461:    */     public boolean remove(Object o)
/* 462:    */     {
/* 463:547 */       return CharObjectHashMap.this.remove(o) != null;
/* 464:    */     }
/* 465:    */     
/* 466:    */     public boolean retainAll(Collection<?> retainedKeys)
/* 467:    */     {
/* 468:552 */       boolean changed = false;
/* 469:553 */       for (Iterator<CharObjectMap.PrimitiveEntry<V>> iter = CharObjectHashMap.this.entries().iterator(); iter.hasNext();)
/* 470:    */       {
/* 471:554 */         CharObjectMap.PrimitiveEntry<V> entry = (CharObjectMap.PrimitiveEntry)iter.next();
/* 472:555 */         if (!retainedKeys.contains(Character.valueOf(entry.key())))
/* 473:    */         {
...
/* 482:    */     {
/* 483:565 */       CharObjectHashMap.this.clear();
/* 484:    */     }
/* 485:    */     
/* 486:    */     public Iterator<Character> iterator()
/* 487:    */     {
/* 488:570 */       new Iterator()
/* 489:    */       {
/* 490:571 */         private final Iterator<Map.Entry<Character, V>> iter = CharObjectHashMap.this.entrySet.iterator();
/* 491:    */         
...
/* 495:    */         }
/* 496:    */         
/* 497:    */         public Character next()
/* 498:    */         {
/* 499:580 */           return (Character)((Map.Entry)this.iter.next()).getKey();
/* 500:    */         }
/* 501:    */         
...
/* 511:    */     implements Iterator<CharObjectMap.PrimitiveEntry<V>>, CharObjectMap.PrimitiveEntry<V>
/* 512:    */   {
...
/* 520:    */     {
/* 521:600 */       while ((++this.nextIndex != CharObjectHashMap.this.values.length) && (CharObjectHashMap.this.values[this.nextIndex] == null)) {}
/* 522:    */     }
/* 523:    */     
...
/* 527:607 */         scanNext();
/* 528:    */       }
/* 529:609 */       return this.nextIndex != CharObjectHashMap.this.values.length;
/* 530:    */     }
/* 531:    */     
/* 532:    */     public CharObjectMap.PrimitiveEntry<V> next()
/* 533:    */     {
/* 534:614 */       if (!hasNext()) {
...
/* 549:    */       }
/* 550:631 */       if (CharObjectHashMap.this.removeAt(this.prevIndex)) {
...
/* 556:    */     public char key()
/* 557:    */     {
/* 558:645 */       return CharObjectHashMap.this.keys[this.entryIndex];
/* 559:    */     }
/* 560:    */     
/* 561:    */     public V value()
/* 562:    */     {
/* 563:650 */       return CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/* 564:    */     }
/* 565:    */     
/* 566:    */     public void setValue(V value)
/* 567:    */     {
/* 568:655 */       CharObjectHashMap.this.values[this.entryIndex] = CharObjectHashMap.toInternal(value);
/* 569:    */     }
/* 570:    */   }
/* 571:    */   
/* 572:    */   private final class MapIterator
/* 573:    */     implements Iterator<Map.Entry<Character, V>>
/* 574:    */   {
/* 575:663 */     private final CharObjectHashMap<V>.PrimitiveIterator iter = new CharObjectHashMap.PrimitiveIterator(CharObjectHashMap.this, null);
/* 576:    */     
...
/* 582:    */     }
/* 583:    */     
/* 584:    */     public Map.Entry<Character, V> next()
/* 585:    */     {
/* 586:672 */       if (!hasNext()) {
...
/* 590:    */       
/* 591:678 */       return new CharObjectHashMap.MapEntry(CharObjectHashMap.this, CharObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/* 592:    */     }
/* 593:    */     
...
/* 601:    */     implements Map.Entry<Character, V>
/* 602:    */   {
...
/* 608:    */     }
/* 609:    */     
/* 610:    */     public Character getKey()
/* 611:    */     {
/* 612:699 */       verifyExists();
/* 613:700 */       return Character.valueOf(CharObjectHashMap.this.keys[this.entryIndex]);
/* 614:    */     }
/* 615:    */     
/* 616:    */     public V getValue()
/* 617:    */     {
/* 618:705 */       verifyExists();
/* 619:706 */       return CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/* 620:    */     }
/* 621:    */     
/* 622:    */     public V setValue(V value)
/* 623:    */     {
/* 624:711 */       verifyExists();
/* 625:712 */       V prevValue = CharObjectHashMap.toExternal(CharObjectHashMap.this.values[this.entryIndex]);
/* 626:713 */       CharObjectHashMap.this.values[this.entryIndex] = CharObjectHashMap.toInternal(value);
/* 627:714 */       return prevValue;
/* 628:    */     }
/* 629:    */     
/* 630:    */     private void verifyExists()
/* 631:    */     {
/* 632:718 */       if (CharObjectHashMap.this.values[this.entryIndex] == null) {
 ...
 * Qualified Name:     io.netty.util.collection.CharObjectHashMap
