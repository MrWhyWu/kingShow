...
/*  13:    */ 
/*  14:    */ public class IntObjectHashMap<V>
/*  15:    */   implements IntObjectMap<V>
/*  16:    */ {
...
/*  24:    */   private int size;
/*  25:    */   private int mask;
/*  26: 62 */   private final Set<Integer> keySet = new KeySet(null);
/*  27: 63 */   private final Set<Map.Entry<Integer, V>> entrySet = new EntrySet(null);
/*  28: 64 */   private final Iterable<IntObjectMap.PrimitiveEntry<V>> entries = new Iterable()
/*  29:    */   {
/*  30:    */     public Iterator<IntObjectMap.PrimitiveEntry<V>> iterator()
/*  31:    */     {
/*  32: 67 */       return new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/*  33:    */     }
/*  34:    */   };
/*  35:    */   
/*  36:    */   public IntObjectHashMap()
/*  37:    */   {
/*  38: 72 */     this(8, 0.5F);
/*  39:    */   }
/*  40:    */   
/*  41:    */   public IntObjectHashMap(int initialCapacity)
/*  42:    */   {
/*  43: 76 */     this(initialCapacity, 0.5F);
/*  44:    */   }
/*  45:    */   
/*  46:    */   public IntObjectHashMap(int initialCapacity, float loadFactor)
/*  47:    */   {
...
/*  56:    */     
/*  57:    */ 
/*  58: 93 */     this.keys = new int[capacity];
/*  59:    */     
...
/* 105:    */   }
/* 106:    */   
/* 107:    */   public void putAll(Map<? extends Integer, ? extends V> sourceMap)
/* 108:    */   {
/* 109:    */     IntObjectHashMap<V> source;
/* 110:148 */     if ((sourceMap instanceof IntObjectHashMap))
/* 111:    */     {
/* 112:151 */       source = (IntObjectHashMap)sourceMap;
...
/* 120:158 */       return;
/* 121:    */     }
/* 122:162 */     for (Map.Entry<? extends Integer, ? extends V> entry : sourceMap.entrySet()) {
/* 123:163 */       put((Integer)entry.getKey(), entry.getValue());
/* 124:    */     }
/* 125:    */   }
/* 126:    */   
/* 127:    */   public V remove(int key)
/* 128:    */   {
...
/* 149:    */   {
/* 150:191 */     Arrays.fill(this.keys, 0);
/* 151:192 */     Arrays.fill(this.values, null);
/* 152:193 */     this.size = 0;
/* 153:    */   }
/* 154:    */   
/* 155:    */   public boolean containsKey(int key)
/* 156:    */   {
...
/* 169:    */   }
/* 170:    */   
/* 171:    */   public Iterable<IntObjectMap.PrimitiveEntry<V>> entries()
/* 172:    */   {
...
/* 183:    */         {
/* 184:225 */           final IntObjectHashMap<V>.PrimitiveIterator iter = new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/* 185:    */           
...
/* 203:    */       public int size()
/* 204:    */       {
/* 205:246 */         return IntObjectHashMap.this.size;
/* 206:    */       }
/* 207:    */     };
/* 208:    */   }
/* 209:    */   
...
/* 222:273 */       return true;
/* 223:    */     }
/* 224:275 */     if (!(obj instanceof IntObjectMap)) {
/* 225:276 */       return false;
/* 226:    */     }
/* 227:279 */     IntObjectMap other = (IntObjectMap)obj;
...
/* 260:    */   }
/* 261:    */   
/* 262:    */   public V put(Integer key, V value)
/* 263:    */   {
...
/* 270:    */   }
/* 271:    */   
/* 272:    */   public Set<Integer> keySet()
/* 273:    */   {
/* 274:322 */     return this.keySet;
/* 275:    */   }
/* 276:    */   
/* 277:    */   public Set<Map.Entry<Integer, V>> entrySet()
/* 278:    */   {
/* 279:327 */     return this.entrySet;
/* 280:    */   }
/* 281:    */   
/* 282:    */   private int objectToKey(Object key)
/* 283:    */   {
/* 284:331 */     return ((Integer)key).intValue();
/* 285:    */   }
/* 286:    */   
/* 287:    */   private int indexOf(int key)
/* 288:    */   {
...
/* 301:    */   }
/* 302:    */   
/* 303:    */   private int hashIndex(int key)
/* 304:    */   {
/* 305:365 */     return hashCode(key) & this.mask;
/* 306:    */   }
/* 307:    */   
/* 308:    */   private static int hashCode(int key)
/* 309:    */   {
/* 310:372 */     return key;
/* 311:    */   }
/* 312:    */   
...
/* 369:    */   {
/* 370:452 */     int[] oldKeys = this.keys;
/* 371:453 */     V[] oldVals = this.values;
/* 372:    */     
/* 373:455 */     this.keys = new int[newCapacity];
/* 374:    */     
...
/* 423:    */   }
/* 424:    */   
/* 425:    */   protected String keyToString(int key)
/* 426:    */   {
/* 427:513 */     return Integer.toString(key);
/* 428:    */   }
/* 429:    */   
/* 430:    */   private final class EntrySet
/* 431:    */     extends AbstractSet<Map.Entry<Integer, V>>
/* 432:    */   {
/* 433:    */     private EntrySet() {}
/* 434:    */     
/* 435:    */     public Iterator<Map.Entry<Integer, V>> iterator()
/* 436:    */     {
/* 437:522 */       return new IntObjectHashMap.MapIterator(IntObjectHashMap.this, null);
/* 438:    */     }
/* 439:    */     
/* 440:    */     public int size()
/* 441:    */     {
/* 442:527 */       return IntObjectHashMap.this.size();
/* 443:    */     }
/* 444:    */   }
/* 445:    */   
/* 446:    */   private final class KeySet
/* 447:    */     extends AbstractSet<Integer>
/* 448:    */   {
/* 449:    */     private KeySet() {}
/* 450:    */     
/* 451:    */     public int size()
/* 452:    */     {
/* 453:537 */       return IntObjectHashMap.this.size();
/* 454:    */     }
/* 455:    */     
/* 456:    */     public boolean contains(Object o)
/* 457:    */     {
/* 458:542 */       return IntObjectHashMap.this.containsKey(o);
/* 459:    */     }
/* 460:    */     
/* 461:    */     public boolean remove(Object o)
/* 462:    */     {
/* 463:547 */       return IntObjectHashMap.this.remove(o) != null;
/* 464:    */     }
/* 465:    */     
/* 466:    */     public boolean retainAll(Collection<?> retainedKeys)
/* 467:    */     {
/* 468:552 */       boolean changed = false;
/* 469:553 */       for (Iterator<IntObjectMap.PrimitiveEntry<V>> iter = IntObjectHashMap.this.entries().iterator(); iter.hasNext();)
/* 470:    */       {
/* 471:554 */         IntObjectMap.PrimitiveEntry<V> entry = (IntObjectMap.PrimitiveEntry)iter.next();
/* 472:555 */         if (!retainedKeys.contains(Integer.valueOf(entry.key())))
/* 473:    */         {
...
/* 482:    */     {
/* 483:565 */       IntObjectHashMap.this.clear();
/* 484:    */     }
/* 485:    */     
...
/* 489:    */       {
/* 490:571 */         private final Iterator<Map.Entry<Integer, V>> iter = IntObjectHashMap.this.entrySet.iterator();
/* 491:    */         
...
/* 495:    */         }
/* 496:    */         
/* 497:    */         public Integer next()
/* 498:    */         {
/* 499:580 */           return (Integer)((Map.Entry)this.iter.next()).getKey();
/* 500:    */         }
/* 501:    */         
...
/* 511:    */     implements Iterator<IntObjectMap.PrimitiveEntry<V>>, IntObjectMap.PrimitiveEntry<V>
/* 512:    */   {
...
/* 520:    */     {
/* 521:600 */       while ((++this.nextIndex != IntObjectHashMap.this.values.length) && (IntObjectHashMap.this.values[this.nextIndex] == null)) {}
/* 522:    */     }
/* 523:    */     
...
/* 527:607 */         scanNext();
/* 528:    */       }
/* 529:609 */       return this.nextIndex != IntObjectHashMap.this.values.length;
/* 530:    */     }
/* 531:    */     
/* 532:    */     public IntObjectMap.PrimitiveEntry<V> next()
/* 533:    */     {
/* 534:614 */       if (!hasNext()) {
...
/* 549:    */       }
/* 550:631 */       if (IntObjectHashMap.this.removeAt(this.prevIndex)) {
...
/* 556:    */     public int key()
/* 557:    */     {
/* 558:645 */       return IntObjectHashMap.this.keys[this.entryIndex];
/* 559:    */     }
/* 560:    */     
/* 561:    */     public V value()
/* 562:    */     {
/* 563:650 */       return IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/* 564:    */     }
/* 565:    */     
/* 566:    */     public void setValue(V value)
/* 567:    */     {
/* 568:655 */       IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(value);
/* 569:    */     }
/* 570:    */   }
/* 571:    */   
/* 572:    */   private final class MapIterator
/* 573:    */     implements Iterator<Map.Entry<Integer, V>>
/* 574:    */   {
/* 575:663 */     private final IntObjectHashMap<V>.PrimitiveIterator iter = new IntObjectHashMap.PrimitiveIterator(IntObjectHashMap.this, null);
/* 576:    */     
...
/* 582:    */     }
/* 583:    */     
/* 584:    */     public Map.Entry<Integer, V> next()
/* 585:    */     {
/* 586:672 */       if (!hasNext()) {
...
/* 590:    */       
/* 591:678 */       return new IntObjectHashMap.MapEntry(IntObjectHashMap.this, IntObjectHashMap.PrimitiveIterator.access$1100(this.iter));
/* 592:    */     }
/* 593:    */     
...
/* 601:    */     implements Map.Entry<Integer, V>
/* 602:    */   {
...
/* 608:    */     }
/* 609:    */     
/* 610:    */     public Integer getKey()
/* 611:    */     {
/* 612:699 */       verifyExists();
/* 613:700 */       return Integer.valueOf(IntObjectHashMap.this.keys[this.entryIndex]);
/* 614:    */     }
/* 615:    */     
/* 616:    */     public V getValue()
/* 617:    */     {
/* 618:705 */       verifyExists();
/* 619:706 */       return IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/* 620:    */     }
/* 621:    */     
/* 622:    */     public V setValue(V value)
/* 623:    */     {
/* 624:711 */       verifyExists();
/* 625:712 */       V prevValue = IntObjectHashMap.toExternal(IntObjectHashMap.this.values[this.entryIndex]);
/* 626:713 */       IntObjectHashMap.this.values[this.entryIndex] = IntObjectHashMap.toInternal(value);
/* 627:714 */       return prevValue;
/* 628:    */     }
/* 629:    */     
/* 630:    */     private void verifyExists()
/* 631:    */     {
/* 632:718 */       if (IntObjectHashMap.this.values[this.entryIndex] == null) {
