...
/*  10:    */ 
/*  11:    */ public final class LongCollections
/*  12:    */ {
/*  13: 29 */   private static final LongObjectMap<Object> EMPTY_MAP = new EmptyMap(null);
/*  14:    */   
/*  15:    */   public static <V> LongObjectMap<V> emptyMap()
/*  16:    */   {
/*  17: 39 */     return EMPTY_MAP;
/*  18:    */   }
/*  19:    */   
/*  20:    */   public static <V> LongObjectMap<V> unmodifiableMap(LongObjectMap<V> map)
/*  21:    */   {
/*  22: 46 */     return new UnmodifiableMap(map);
/*  23:    */   }
/*  24:    */   
/*  25:    */   private static final class EmptyMap
/*  26:    */     implements LongObjectMap<Object>
/*  27:    */   {
/*  28:    */     public Object get(long key)
/*  29:    */     {
/*  30: 55 */       return null;
/*  31:    */     }
/*  32:    */     
/*  33:    */     public Object put(long key, Object value)
/*  34:    */     {
/*  35: 60 */       throw new UnsupportedOperationException("put");
/*  36:    */     }
/*  37:    */     
/*  38:    */     public Object remove(long key)
/*  39:    */     {
/*  40: 65 */       return null;
/*  41:    */     }
/*  42:    */     
...
/*  59:    */     
/*  60:    */     public Set<Long> keySet()
/*  61:    */     {
/*  62: 90 */       return Collections.emptySet();
/*  63:    */     }
/*  64:    */     
/*  65:    */     public boolean containsKey(long key)
/*  66:    */     {
/*  67: 95 */       return false;
/*  68:    */     }
/*  69:    */     
...
/*  73:    */     }
/*  74:    */     
/*  75:    */     public Iterable<LongObjectMap.PrimitiveEntry<Object>> entries()
/*  76:    */     {
...
/*  83:    */     }
/*  84:    */     
/*  85:    */     public Object put(Long key, Object value)
/*  86:    */     {
...
/*  93:    */     }
/*  94:    */     
/*  95:    */     public void putAll(Map<? extends Long, ?> m)
/*  96:    */     {
...
/* 103:    */     }
/* 104:    */     
/* 105:    */     public Set<Map.Entry<Long, Object>> entrySet()
/* 106:    */     {
...
/* 112:    */     implements LongObjectMap<V>
/* 113:    */   {
/* 114:    */     private final LongObjectMap<V> map;
/* 115:    */     private Set<Long> keySet;
/* 116:    */     private Set<Map.Entry<Long, V>> entrySet;
/* 117:    */     private Collection<V> values;
/* 118:    */     private Iterable<LongObjectMap.PrimitiveEntry<V>> entries;
/* 119:    */     
/* 120:    */     UnmodifiableMap(LongObjectMap<V> map)
/* 121:    */     {
/* 122:152 */       this.map = map;
/* 123:    */     }
/* 124:    */     
/* 125:    */     public V get(long key)
/* 126:    */     {
/* 127:157 */       return this.map.get(key);
/* 128:    */     }
/* 129:    */     
/* 130:    */     public V put(long key, V value)
/* 131:    */     {
...
/* 173:    */     }
/* 174:    */     
/* 175:    */     public V put(Long key, V value)
/* 176:    */     {
...
/* 183:    */     }
/* 184:    */     
/* 185:    */     public void putAll(Map<? extends Long, ? extends V> m)
/* 186:    */     {
/* 187:217 */       throw new UnsupportedOperationException("putAll");
/* 188:    */     }
/* 189:    */     
/* 190:    */     public Iterable<LongObjectMap.PrimitiveEntry<V>> entries()
/* 191:    */     {
/* 192:222 */       if (this.entries == null) {
/* 193:223 */         this.entries = new Iterable()
/* 194:    */         {
/* 195:    */           public Iterator<LongObjectMap.PrimitiveEntry<V>> iterator()
/* 196:    */           {
/* 197:226 */             return new LongCollections.UnmodifiableMap.IteratorImpl(LongCollections.UnmodifiableMap.this, LongCollections.UnmodifiableMap.this.map.entries().iterator());
/* 198:    */           }
/* 199:    */         };
/* 200:    */       }
...
/* 210:    */     }
/* 211:    */     
/* 212:    */     public Set<Map.Entry<Long, V>> entrySet()
/* 213:    */     {
...
/* 229:    */       implements Iterator<LongObjectMap.PrimitiveEntry<V>>
/* 230:    */     {
/* 231:    */       final Iterator<LongObjectMap.PrimitiveEntry<V>> iter;
/* 232:    */       
/* 233:    */       IteratorImpl()
/* 234:    */       {
...
/* 241:    */       }
/* 242:    */       
/* 243:    */       public LongObjectMap.PrimitiveEntry<V> next()
/* 244:    */       {
/* 245:275 */         if (!hasNext()) {
/* 246:276 */           throw new NoSuchElementException();
/* 247:    */         }
/* 248:278 */         return new LongCollections.UnmodifiableMap.EntryImpl(LongCollections.UnmodifiableMap.this, (LongObjectMap.PrimitiveEntry)this.iter.next());
/* 249:    */       }
/* 250:    */       
...
/* 258:    */       implements LongObjectMap.PrimitiveEntry<V>
/* 259:    */     {
/* 260:    */       private final LongObjectMap.PrimitiveEntry<V> entry;
/* 261:    */       
/* 262:    */       EntryImpl()
/* 263:    */       {
 ...
 * Qualified Name:     io.netty.util.collection.LongCollections
