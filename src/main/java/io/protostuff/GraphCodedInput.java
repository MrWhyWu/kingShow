...
/*   5:    */ 
/*   6:    */ public final class GraphCodedInput
/*   7:    */   extends FilterInput<CodedInput>
...
/*  14:    */   
/*  15:    */   public GraphCodedInput(CodedInput input)
/*  16:    */   {
/*  17: 40 */     super(input);
/*  18:    */     
/*  19:    */ 
...
/*  23:    */   }
/*  24:    */   
/*  25:    */   public GraphCodedInput(CodedInput input, int initialCapacity)
/*  26:    */   {
/*  27: 50 */     super(input);
/*  28:    */     
/*  29:    */ 
...
/*  50:    */   {
/*  51: 78 */     int fieldNumber = ((CodedInput)this.input).readFieldNumber(schema);
/*  52: 79 */     if (WireFormat.getTagWireType(((CodedInput)this.input).getLastTag()) == 6)
/*  53:    */     {
/*  54: 82 */       this.lastRef = ((CodedInput)this.input).readUInt32();
...
/*  75:    */     
/*  76:111 */     ((CodedInput)this.input).mergeObject(value, this);
/*  77:    */     
/*  78:113 */     return value;
/*  79:    */   }
/*  80:    */   
...
/*  85:120 */       ((CodedInput)this.input).skipField(((CodedInput)this.input).getLastTag());
/*  86:    */     }
/*  87:    */   }
/*  88:    */   
 ...
 * Qualified Name:     io.protostuff.GraphCodedInput
