...
public final class UnsafeUtil
{
  ...
  static
  {
    ...
    } catch (Throwable t) { Unsafe _unsafe;
  ...
  private static final long BYTE_ARRAY_BASE_OFFSET = arrayBaseOffset([B.class);
  


  private static final long BOOLEAN_ARRAY_BASE_OFFSET = arrayBaseOffset([Z.class);
  private static final long BOOLEAN_ARRAY_INDEX_SCALE = arrayIndexScale([Z.class);
  
  private static final long INT_ARRAY_BASE_OFFSET = arrayBaseOffset([I.class);
  private static final long INT_ARRAY_INDEX_SCALE = arrayIndexScale([I.class);
  
  private static final long LONG_ARRAY_BASE_OFFSET = arrayBaseOffset([J.class);
  private static final long LONG_ARRAY_INDEX_SCALE = arrayIndexScale([J.class);
  
  private static final long FLOAT_ARRAY_BASE_OFFSET = arrayBaseOffset([F.class);
  private static final long FLOAT_ARRAY_INDEX_SCALE = arrayIndexScale([F.class);
  
  private static final long DOUBLE_ARRAY_BASE_OFFSET = arrayBaseOffset([D.class);
  private static final long DOUBLE_ARRAY_INDEX_SCALE = arrayIndexScale([D.class);
  
  private static final long OBJECT_ARRAY_BASE_OFFSET = arrayBaseOffset([Ljava.lang.Object.class);
  private static final long OBJECT_ARRAY_INDEX_SCALE = arrayIndexScale([Ljava.lang.Object.class);
  ...
  {
    return field(String.class, "value", [C.class);
  }
  ...
  public static class MemoryAccessor {
    ...
    MemoryAccessor(Unsafe unsafe) { this.unsafe = unsafe; }
